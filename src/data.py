...
PARALLEL_STEP = 20.
PARALLEL_MIN = 16.6239
PARALLEL_MAX = 90.
PLOTTER_PARALLELS = np.arange(PARALLEL_MIN, PARALLEL_MAX, PARALLEL_STEP)
...
class Plotter:
    def __init__(self):
        ...
        map = Basemap(width = meters, height = meters,
                      projection = 'laea',
                      lon_0 =  0., lat_0 = 90.,
                      ellps = 'WGS84',
                      resolution = 'i')

        map.drawparallels(PLOTTER_PARALLELS)
        map.drawmeridians(PLOTTER_MERIDIANS)
